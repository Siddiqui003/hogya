...
export const roomService = {
  ...
  adminToggleJoin:   (id)               => api.patch(`/admin/rooms/${id}/toggleJoinable`),
  adminSoftDelete:   (id)               => api.delete(`/admin/rooms/${id}`),
  adminHardDelete:   (id)               => api.delete(`/admin/rooms/${id}/hard`),
